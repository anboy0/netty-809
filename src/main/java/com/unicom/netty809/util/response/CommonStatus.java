 ...
 * @Desc: 公共-响应码
 * @author:zhengs
 * @Time: 18-12-29 上午9:04
 * @Copyright: ©  杭州凯立通信有限公司 版权所有
 * @Warning: 本内容仅限于公司内部传阅,禁止外泄或用于其它商业目的
 */
public enum CommonStatus implements IResponseStatus {
    ...
    NEW_CONFIRM_DIFFERENT(600, "两次密码输入不一样"),
    OLD_PASSWORD_ERROR(600, "原密码不正确"),
    LOGIN_ERROR(600, "用户名或密码不正确"),
    PHONE_ERROR(600, "手机号格式不正确"),
    PHONE_NOEXIST(600, "手机号不存在"),
    PASSWORD_ERROR(600, "密码格式不正确"),
    EMAIL_ERROR(600,"邮箱格式不正确"),
    SAVE_OK(200, "保存成功"),
    USER_NAME_REPEAT(500,"用户名重复"),
    ROLE_NAME_REPEAT(500,"角色名重复"),
    DEPT_NAME_REPEAT(500,"部门名重复"),
    DICT_NAME_REPEAT(500,"部门名重复"),
    ACCOUNT_REPEAT(500,"该账号已注册"),
    PHONE_REPEAT(500,"该手机号已注册"),
    LOGOUT_SUCCESS(200,"退出成功"),
    ROLE_HAVE_MENU(600,"该角色已分配权限"),
    ROLE_NO_AUTHOORITY(400,"用户没有分配权限"),
    VERIFYCODE_INVALIDE(400,"无效验证码,请重新输入"),
    INTERNAL_ERROR(-1, "系统内部异常，请联系管理员。"),
    CODE_REPEAT(500,"该编号已存在"),
